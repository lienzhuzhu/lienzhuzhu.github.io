...
Please see the series [overview post](/posts/2023/05/tcp/) for setup instructions.
...
<figure>
  ...
  <figcaption>The existing telnet connection with a command executed. This image also shows the initial command used to establish the connection.</figcaption>
</figure>
