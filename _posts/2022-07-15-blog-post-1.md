---
title: "Comparing AWS EC2 Instances"
date: 2022-07-15
permalink: /posts/2022/07/aws-ec2/
tags:
  - tech
  - web
---
...
<div class="logo-container">
    <img src="/images/2022-07-15-blog-post-1/ec2-logo.png" alt="ec2 logo" class="logo">
    <img src="/images/2022-07-15-blog-post-1/apache.png" alt="apache logo" class="logo">
</div>
...
Figure 1 shows the requests per second (Fig. 1a) and time per request (Fig. 1b) that Apache was able to handle the requests on each instance.
 ...
 <div class="halves-container">
    <figure>
        <img src="/images/2022-07-15-blog-post-1/requests.png" alt="graph" class="figure-img">
    ...
    <figure>
        <img src="/images/2022-07-15-blog-post-1/time.png" alt="graph" class="figure-img">
        <figcaption class="figure-caption">
...
<div class="thirds-container">
    <figure>
        <img src="/images/2022-07-15-blog-post-1/html.png" alt="graph" class="figure-img">
        <figcaption class="figure-caption">
    ...
    <figure>
        <img src="/images/2022-07-15-blog-post-1/php.png" alt="graph" class="figure-img">
        <figcaption class="figure-caption">
    ...
    <figure>
        <img src="/images/2022-07-15-blog-post-1/jpeg.png" alt="graph" class="figure-img">
        <figcaption class="figure-caption">
